...
tests_dir_fsic_sp = tests_dir_sp / "fsic"
tests_dir_moslv_sp = tests_dir_sp / "moslv"
...
def plot_tb_mos_id_vd(
    ...
    filepath_sp_paramset = tests_dir_fsic_sp  / "ref" / (test_name + '.sp.out')
    filepath_sp_generic  = tests_dir_moslv_sp / "ref" / (test_name + '.sp.out')
